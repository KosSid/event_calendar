...
const EventListItem: React.FC<EventLiProps> = ({ event }) => {
  ...
  return (
    <li className="p-3 mb-2 border-b-2 border-red-100 text-stone-50 relative">
      ...
      <div className=" flex divide-x divide-red-100 absolute top-7 right-4">
        <Button className="text-red-100 mx-0 rounded-l-lg bg-red-400 w-8 flex items-center justify-center">
          <MdEdit />
        </Button>
        <Button
